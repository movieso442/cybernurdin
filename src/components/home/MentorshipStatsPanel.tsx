  ...
  return (
    <section className="w-full bg-[#FFF8EF]">
      <div className="w-full px-6 py-2 sm:px-8 lg:px-16 2xl:px-20">
        <div className="relative overflow-hidden rounded-lg bg-[#061C36] px-6 py-7 text-white shadow-[0_20px_42px_rgba(6,28,54,0.18)] md:px-10">
          ...
          <div className="relative grid gap-7 lg:grid-cols-[0.95fr_1.05fr_1fr] lg:items-center">
                  ...
                  <div key={item.label} className="flex items-center justify-between text-sm">
                    <span className="flex items-center gap-2 text-white/88">
                      {item.locked ? (
                        ...
                        <span className="grid h-4 w-4 place-items-center rounded-full border border-[#F5D35E] text-[9px] text-[#F5D35E]">•</span>
                      ) : (
